      ...
      <div class="max-w-3xl p-6 mx-auto text-slate-900">
        <div class="flex flex-wrap pb-8 mb-8 border-b md:flex-nowrap">
          <div class="mb-8 md:basis-3/5">
            <img
              ...
              alt="Le Quoc Huy"
              class="w-24 h-24 rounded-full md:w-32 md:h-32"
            />
          </div>
          <div>
              ...
              <ul class="flex space-x-4">
                <li>
                  <a
                    ...
                    target="_blank"
                    class="transition-all text-slate-800 hover:text-fuchsia-500 group"
                    title="GitHub"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      class="w-5 h-5 transition-all group-hover:-translate-y-0.5"
                      viewBox="0 0 16 16"
                    >
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    class="text-blue-500 transition-all hover:text-fuchsia-500 group"
                    title="Facebook"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    class="text-blue-400 transition-all hover:text-fuchsia-500 group"
                    title="Twitter"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="space-y-8">
          <div>
            <a
              href="/blog"
              class="transition-all hover:text-fuchsia-500"
              title="Cách Cài Đặt NextJS"
            >
              <h2 class="font-semibold">Cách Cài Đặt NextJS 12</h2>
            </a>
            ...
            <a
              href="/blog"
              class="mt-1.5 flex items-center font-medium text-sm group text-fuchsia-500 gap-0.5"
            >
              Read more
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="w-4 h-4 mt-0.5 transition-transform group-hover:translate-x-1"
              >
                <path
